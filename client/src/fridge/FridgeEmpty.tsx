...
export const FridgeEmpty: React.StatelessComponent<FridgeEmptyProps> = props => {
  ...
  return (
    <div className="FridgeContentEmpty">
      ...
      <p>No thanks, just <a onClick={add} style={{ textDecoration: 'underline', cursor: 'pointer', color: 'inherit' }}>add <Ingredient name="broccoli" icon="//twemoji.maxcdn.com/2/72x72/1f966.png" /></a>.</p>
    </div>
  );
};
